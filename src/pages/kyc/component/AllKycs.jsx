...
const AllKycs = ({ allKyc, loading, setUserActionLoading, userActionLoading }) => {
  ...
  console.log(allKyc, "allKyc")
    ...
    const handlePageClick = (event) => {
        const newOffset = (event.selected * perPage) % allKyc?.length;
        console.log(
                    ...
                    <td className='h-[70px] px-4 flex justify-center items-center'>
                        <Popover className="relative">
                            ...
                            <Popover.Panel>
                                ...
                                >
                                  <p onClick={() => {setOpenDetails(true); setDetailsData(data)}} className='w-full p-2 bg-white hover:bg-[#ccc] hover:rounded-lg text-start text-[15px]'>Details</p>
                                </Popover.Button>
                            </Popover.Panel>
                        </Popover>
                    </td>
